...
function Navbar() {
  ...
  return (
    <nav className="relative flex w-full justify-between pl-4 pr-6 lg:px-14 pt-12 sm:py-5 lg:pt-12 sm:pt-12">
      ...
      {/* Desktop Menu */}
      <div className="nav-right hidden lg:flex space-x-6 pt-6 font-inter">
      ...
      {isOpen && (
      <div className="fixed top-0 left-0 w-full h-full bg-white z-50 lg:hidden font-inter">
        {/* Close button */}
